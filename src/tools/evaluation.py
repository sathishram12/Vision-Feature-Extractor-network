...
def main(): 
    ...
    """
    Create evaluation folder, metrics file, confusion matrix file
    """
    ...
    """
    Get the category name and corresponding index, and get the annotation file
    """
    ...
    """
    Make a test set and feed it to Dataloader
    """
