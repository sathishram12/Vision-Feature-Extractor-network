...
from configs.build import BuildNet
...
def main():
    # Read the configuration file to obtain key fields
    args = parse_args()
    ...
    # Read training & produce verification label data
    ...
    #Initialize learning rate update strategy
    lr_update_func = eval(lr_config.pop('type'))(**lr_config)
    
    # create data set->Data enhancement & preprocessing
    ...
    # Store key fields to facilitate synchronous calls & updates during training
    runner = dict(
        optimizer         = optimizer,
    ...
    # Whether to resume training from the point of interruption
    if args.resume_from:
    ...
    # Initialize and save training information class
